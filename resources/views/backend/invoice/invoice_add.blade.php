...
<div class="card">
    ...
    <div class="col-md-1">
        <div class="md-3">
            ...
            <input class="form-control example-date-input" name="invoice_no" value="{{$invoice_no}}" type="text" id="invoice_no" readonly sytle="background-color: #ddd">
        </div>
    </div>    
    ...
    <div class="col-md-1">
        <div class="md-3">
            <label class="form-label">Stock(PCS/KG)</label>
            <input class="form-control example-date-input" name="current_stock_qty" type="text" id="current_stock_qty" sytle="background-color: #ddd" readonly>
        </div>
    </div>      
